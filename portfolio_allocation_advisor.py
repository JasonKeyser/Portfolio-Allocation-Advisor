...
def effic_front(co, pa, me, sd, r):
    ...
    #this calculates portolio expected return
    for stock in stocks:
...
#runs the function for retrieving stock price data
...
ports = pd.DataFrame(list, columns = ['Weights', 'Sharpe', 'S_Deviation', 'Expected Return'])
